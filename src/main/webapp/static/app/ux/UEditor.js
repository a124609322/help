Ext.define('app.ux.UEditor', {
    ...
    fieldSubTpl: [
        '<script type="text/plain" id="{id}" {inputAttrTpl}',
        ...
        ' autocomplete="off">\n',
        '<tpl if="value">{[Ext.com.chuandu.util.Format.htmlEncode(values.value)]}</tpl>',
        '</script>',
        {
            disableFormats: true
        }
    ...
    afterRender: function () {
        ...
        if (!me.ue) {
            me.ue = UE.getEditor(me.getInputId(), Ext.apply(me.ueditorConfig, {
                initialFrameHeight: me.height || '200px',
    ...
    getRawValue: function () {
        ...
        var v = (me.inputEl ? me.inputEl.getValue() : '');
        me.rawValue = v;
        return v;
    },

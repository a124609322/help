...
Ext.define('Ext.ux.uploadPanel.UploadPanel',{
	...
	columns : [
        ...
        {text: '进度', width: 150,dataIndex: 'percent',renderer:function(v){
			var stml =
				'<div>'+
		...
		}},
        {
            xtype:'actioncolumn',
            items: [{
                icon: '/Ext/ux/uploadPanel/icons/delete.png',
                tooltip: 'Remove',
	...
	post_params : {},
	upload_url : 'test.do',
	flash_url : "/Ext/ux/uploadPanel/swfupload/swfupload.swf",
	flash9_url : "/Ext/ux/uploadPanel/swfupload/swfupload_fp9.swf",
	...
	getSWFConfig : function(btn){
		...
		return {
			...
			file_post_name:em.file_post_name,
	...
	upload_start_handler : function(file){
		...
		this.setFilePostName(encodeURIComponent(me.file_post_name));
	},
